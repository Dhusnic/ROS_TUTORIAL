...
(cl:defmethod cl:initialize-instance :after ((m <multiplier-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'multiplier-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_pkg-srv:<multiplier-request> is deprecated: use ros_pkg-srv:multiplier-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <multiplier-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_pkg-srv:a-val is deprecated.  Use ros_pkg-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <multiplier-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_pkg-srv:b-val is deprecated.  Use ros_pkg-srv:b instead.")
  (b m))
...
(cl:defmethod cl:initialize-instance :after ((m <multiplier-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'multiplier-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_pkg-srv:<multiplier-response> is deprecated: use ros_pkg-srv:multiplier-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <multiplier-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_pkg-srv:result-val is deprecated.  Use ros_pkg-srv:result instead.")
  (result m))
